                    ...
                    <div class="card-body">
                        <form action="<?= base_url('products/purchase/checkout') ?>" method="POST" id="payment-form">
                            ...
                            <div class="form-group productDetail">
                                ...
                                <input type="text" name="productname" id="productName" value="" class="form-control" placeholder="Enter Product or Service Name for which making payment">

                                <input type="hidden" name="productcode" id="productCode" value="">
                            </div>
                            <div class="form-group row amountpay">
                                <label for="price" class="col-12 col-sm-6 col-md-6 h4">Enter Amount to Pay</label>
                                <div class=" col-12 col-sm-6 col-md-4">
                                    <input type="text" class="form-control" name="price" id="price" value="" onblur="totalPrice();" placeholder="Enter Amount">
                                    <small class="priceError"></small>
                                </div>
                            </div>
                            <div class="form-group row totalpay">
                                ...
                                <div class=" col-12 col-sm-12 col-md-8 text-center">
                                    <span class="badge badge-pill badge-warning payPrice"><i class="fas fa-dollar-sign h5 px-2"></i> <span id="totalPrice" class="h5 p-2">0</span></span>
                                </div>
